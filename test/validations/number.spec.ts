...
test.group('Validations | number', () => {
  test('work fine when the field value is a number (float)', (assert) => {
  ...
  test('work fine when the field value is a number (integer)', (assert) => {
    const data = { age: 47 }
    const root = { original: data, tip: data, pointer: '' }
    const field = 'age'
  ...
  test('cast strings to numbers', (assert) => {
  ...
  test('cast strings with decimal values to numbers', (assert) => {
  ...
  test('return false when the field value is a string', (assert) => {
  ...
  test('return false when the field value is a negative number', (assert) => {
    const data = { price: -10 }
    const root = { original: data, tip: data, pointer: '' }
    const field = 'price'
